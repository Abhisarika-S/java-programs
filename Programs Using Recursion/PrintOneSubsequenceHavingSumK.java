...
public class PrintOneSubsequenceHavingSumK {
    ...
    public static boolean printSubsequence(int index, ArrayList<Integer> subsequence, int sum, int[] originalArray, int k) {
        ...
        if (printSubsequence((index+1), subsequence, sum, originalArray, k) == true) {
            return true;
        }
